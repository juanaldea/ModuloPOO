...
public class EmpleadoDaoImpl
    ...
    try {
      ...
      ResultSet rs = pstm.executeQuery();
      if (!rs.next()) {
        throw new SQLException("ERROR: El contador de Usuarios no existe.");
      }
      ...
      throw new RuntimeException("Error en el proceso Registrar Cliente, intentelo mas tarde.");
    } finally {
      try {
        cn.close();
      } catch (Exception e) {
    ...
    public void actualizar(EmpleadoBean bean) {
      ...
      cn.setAutoCommit(false);
       ...
       String sql = "update empleado set vch_emplpaterno = ?, "
                   + "vch_emplmaterno = ?,vch_emplnombre = ?, "
                   + "vch_emplciudad = ?, vch_empldireccion = ?, "
                   + "vch_emplusuario = ?, vch_emplclave=? "
                   + "where chr_emplcodigo = ? " ;
    ...
    public void eliminar(String codigo) {
      ...
      throw new RuntimeException("Error en el proceso de Eliminar Empleado, intentelo mas tarde.");
    } finally {
      try {
        cn.close();
      } catch (Exception e) {
